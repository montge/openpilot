...
**Purpose:** Define the integration of Meta FAIR research models (DINOv2, SAM 2, CoTracker, DETR, UnSAMFlow) with openpilot for perception enhancement via knowledge distillation, with deployment targeting comma 4 hardware.
