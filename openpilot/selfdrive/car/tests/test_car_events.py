"""Tests for selfdrive/car/car_events.py - car-specific event handling."""
...
class TestCarEventsInit:
  """Test CarEvents initialization."""
...
class TestCarEventsUpdateMockBrand:
